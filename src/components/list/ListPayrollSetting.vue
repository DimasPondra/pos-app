<template>
    <ion-card>
        <ion-card-content>
            <ion-list>
                <ion-item-sliding
                    v-for="payroll_setting in payroll_settings"
                    :key="payroll_setting.id"
            ...
            <div class="centered-container">
                <ion-button
                    ...
                    fill="outline"
                    size="small"
                    v-show="payroll_settings.length < total"
...
export default {
    ...
    setup(props, context) {
        const totalItems = computed(() => {
            return props.payroll_settings.length + " of " + props.total;
        });
